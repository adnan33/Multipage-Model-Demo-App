...
from static import *
from utils.process import demo_human_parsing_segmentation, custom_human_parsing_segmentation
...
method_select = st.selectbox("How would you like to test the model?",["Demo Image","My Own Image"],index=0)
if options_dict[method_select]:
    ...
    uploaded_file = st.file_uploader("Please Input Human Images", type=['jpg','png','jpeg','bmp'])
    output_shape = st.checkbox("Output image shape is equal to input image shape");
