...
download_resource(path = paths.cloth_seg_model_path,
                  url = urls.cloth_seg_model_url,
                  env_key=env_keys.cloth_model_env_key)

download_resource(path = paths.hp_model_path,
                  url = urls.hp_model_url,
                  env_key=env_keys.hp_model_env_key)

download_resource(path = paths.cloth_demo_image_path,
                  url = urls.cloth_demo_image_url,
                  env_key=env_keys.cloth_demo_image_env_key)

download_resource(path = paths.hp_demo_image_path,
